...
Each level has the same structe and the same target, its just different in what the Player has to pick up and which diseas he got. He is able to Pause the game by pressing ESC, then the time stops and he cant move anylonger. 

With the pausemenu he can aswell End the game and jump back to the main menu.
...
Several stuides shown that the eye pressure is the main faktor of an optic nerve damange. By Glaucoma the pressure in the eye is to high that the optic nerve gets damaged. Another faktor is the blood pressure, this also can infact the optic nerves.
...
Glaucoma is espacially a problem for people with a family history of glaucoma. Or everybody over the age of 60. In case of Africans or Americans the risk is already getting higher at the age of 40.

There are no Symptoms in the beginng, the vision stays normal and it causes no pain. But without an treatment, people with glaucoma slowly lose their peripheral vison. Thats why the people start to see the things at the corner of there vision field bad.That is shown in Figure 5. Over the time the visionfield gets smaller and smaller.

Thats why we made a shader which blurres the outer region of the vision. So that is difficult to see items in there outer regions of there vision.
...
Cataract is a diseas which effects the lens of the eye. Its clouding the lens and the effect of this is that the person have difficulties to focus on objects and have a different color perception.

The protein in the eye arrange to keep the lens clear and let the light pass. But in the older ages the protain cant clear the lense anymore and they starting to clump together. This is calld a cataract. Its starts in small areas of the lense and grow lager over the time. Mostly this starts in the center of the lense. Like shown in Figure 6.

The Risk of getting cataract is extremely high for people over the age of 80. The percantage for cataract by people over 80 is about 50\%.
