...
There are no Symptoms in the beginng, the vision stays normal and it causes no pain. But without an treatment, people with glaucoma slowly lose their peripheral vison. Thats why the people start to see the things at the corner of there vision field bad.That is shown in \Fref{fig:glaucoma}. Over the time the visionfield gets smaller and smaller.
...
\subsection{Science}
The game was build CoSMoS compliant espacilly the different diseases where discoverd,modelled. After wards we Tested the different effect of it and documented it in the end. All models base on a scientific background as far as possible. The settings show a specifig state of the diseas, these stats where so selectet that the effect is visuable.
...
Through the different eye diseases, its every time a new chellenge to find the right objects. These will be the one of the main learning effect the other one is to learn with the info texts about the disesas can be recognize and what to do against it.
